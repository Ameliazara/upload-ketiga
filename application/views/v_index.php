        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <span class="navbar-text">
                    Septina zara amelia putri
                </span>
            </div>
        </nav>

        <h1 class="alert alert-info" style="text-align: center">Septina zara amelia <putri>
        <2101060001></2101060001></h1>
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered" border="1" cellspacing="0" cellpadding="10">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Septina zara amelia putri</td>
                                <td>2101060001</td>
                                <td>Beleke</td>
